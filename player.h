...
public:
	...
	V get_moving_offset(Keypress e) {
		switch (e) {
			case Keypress::UP_1: case Keypress::UP_2: return V(0, -speed);
			case Keypress::DOWN_1: case Keypress::DOWN_2: return V(0, speed);
			case Keypress::RIGHT_1: case Keypress::RIGHT_2: return V(speed, 0);
			case Keypress::LEFT_1: case Keypress::LEFT_2: return V(-speed, 0);
