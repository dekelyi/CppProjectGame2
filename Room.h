...
public:
    ...
    /**
     * Construct a new GameRoom with given dimensions and legend position.
     * @param x width in cells
     * @param y height in cells
     * @param legend_pos Y position for HUD legend
     * @param _runner pointer to game runner instance
     */
    ...
    inline void remove_object(MapObject* obj, bool del = true) {
        ...
        map_objects.erase(std::remove(map_objects.begin(), map_objects.end(), obj), map_objects.end());
        // Delete obj if needed
